<h1 align="center">
  <a href="https://www.bytescale.com/docs/upload-widget/vue">
    <img alt="Bytescale Upload Widget for Vue" width="524" height="80" src="https://raw.githubusercontent.com/taktikorg/debitis-cum/main/.github/assets/bytescale-upload-widget-vue.svg">
  </a>
</h1>
<p align="center"><b>Beautiful File Upload Widget for Vue</b><br/> (Works out-the-box, storage included)</p>
<br/>
<p align="center">
  <a href="https://www.npmjs.com/package/@taktikorg/debitis-cum">
    <img src="https://img.shields.io/badge/%40bytescale%2Fupload--widget--vue-npm-4ba0f6" />
  </a>

  <a href="https://github.com/taktikorg/debitis-cum/actions/workflows/ci.yml">
    <img src="https://img.shields.io/badge/build-passing-4ba0f6" />
  </a>

  <a href="https://github.com/taktikorg/debitis-cum/">
...
```shell
npm install @taktikorg/debitis-cum
```

Or via YARN:

```shell
yarn add @taktikorg/debitis-cum
```
...
<script lang="ts">
  import { openUploadModal } from "@taktikorg/debitis-cum";
  import type { UploadWidgetConfig, UploadWidgetResult } from "@bytescale/upload-widget";
  import type { PreventableEvent } from "@taktikorg/debitis-cum";
...
<script lang="ts">
import { UploadDropzone } from "@taktikorg/debitis-cum";
